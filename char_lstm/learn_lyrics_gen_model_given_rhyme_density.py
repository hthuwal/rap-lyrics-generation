    ...
    for epoch_number in range(epochs):
        ...
        if len(avg) != 0:
            ...
            if abs(rhyme_density - rhyme_target) < abs(prev_rhym - rhyme_target):
                ...
                best_model_path = os.path.join("models", "best_models_given_rhyme_density", str(epoch_number) + '_' + model_file)
...
if sys.argv[1] == "fab":
    train("lg_char_fabolous_given_rhyme_density.model", trainset2, "fabolous_given_rhyme_density", batch_size=1, epochs=1000, bias=0)
else:
    train("lg_char_kaggle_given_rhyme_density.model", trainset1, "lg_given_rhyme_density", batch_size=100, epochs=100)
